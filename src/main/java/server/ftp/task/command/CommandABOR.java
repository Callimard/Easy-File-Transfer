...
public class CommandABOR extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "ABOR";

	// Constructors.

	public CommandABOR(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
