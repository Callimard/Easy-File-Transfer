...
public class CommandACCT extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "ACCT";

	// Constructors.

	public CommandACCT(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
