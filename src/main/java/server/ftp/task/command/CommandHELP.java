...
public class CommandHELP extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "HELP";

	// Constructors.

	public CommandHELP(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
