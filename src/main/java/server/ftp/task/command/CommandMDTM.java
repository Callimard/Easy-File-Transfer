...
public class CommandMDTM extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "MDTM";

	// Constructors.

	public CommandMDTM(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
