...
public class CommandREFUSED extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "REFUSED";

	// Constructors.

	public CommandREFUSED(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
