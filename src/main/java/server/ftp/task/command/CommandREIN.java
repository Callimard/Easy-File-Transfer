...
public class CommandREIN extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "REIN";

	// Constructors.

	public CommandREIN(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
