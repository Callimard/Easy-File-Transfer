...
public class CommandREST extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "REST";

	// Constructors.

	public CommandREST(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
