...
public class CommandSITE extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "SITE";

	// Constructors.

	public CommandSITE(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
