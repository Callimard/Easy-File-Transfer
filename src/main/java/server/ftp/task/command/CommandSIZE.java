...
public class CommandSIZE extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "SIZE";

	// Constructors.

	public CommandSIZE(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
