...
public class CommandSMNT extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "SMNT";

	// Constructors.

	public CommandSMNT(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
