...
public class CommandSTAT extends FTPCommand {

	// Constants.

	public static final String NAME_CODE = "STAT";

	// Constructors.

	public CommandSTAT(FTPClientConnection clientConnection, FTPServerController ftpServerController, String... args) {
